...
namespace LiarsDice
{
    public partial class StartPage : Form
    {
        ...
        private void PlayBtn_Click(object sender, EventArgs e)
        {
            ...
            _game = new Game((int)playerCount.Value, (int)dicePerPlayer.Value, (int)myPosition.Value);
        ...
        private void NewRound(Player startingPlayer, bool specialRound = false)
        {
            ...
            if (_game.isComputersTurn()) { DoComputersTurn(); }
        }
        ...
        {
            VisualiseClaim(claim);

            _game.submitClaim(claim);
            callLiar.Enabled = true;
            UpdatePlayerTurnLabel();

            if (_game.isSpecialRound()) { ForceDie(); } else { UnforceDie(); }
        ...
        private void VisualiseClaim(Claim claim)
        {
